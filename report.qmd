...
According to this graph we can assume our model is moderately predictive. The mean $R^2$ value appears to be around $0.625$. This means that on average our model explains around $62.5\%$ of the variance in life expectancy. The $R^2$ values range pretty widely. It's from around $0.2$ to above $2$. This means that there is some high variance in the performance across folds. This is most likely due to some folds having a small sample size or there are some outliers in certain folds. There is a chance for some overfitting, but not guaranteed. One fold yields a very high $R^2$ value $> 2$. This could indicate that there is some overreacting to smaller datasets.

## 5. Conclusion

We have found that average life expectancy by country and year has a moderately strong, positive, linear relationship with average years of schooling. We have found that our model of life expectancy and years of schooling is moderately predictive and has slight overfitting. Further research into this relationship could give us insights into the importance of education.
